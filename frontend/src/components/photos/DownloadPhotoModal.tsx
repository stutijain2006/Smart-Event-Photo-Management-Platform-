type Props = {
    onDownload : (variant: "original" | "watermarked" | "compressed") => void
}
export default function DownloadPhotoModal({ onDownload } : Props){
    return(
        <div className="flex flex-col gap-3">
            ...
            <button onClick={() => onDownload("compressed")} className="px-4 py-2 bg-gray-300 text-[1rem]">Compressed</button>
         </div>
    );
}