...
export default function DragDropUpload({onFilesSelected} : Props) {
    ...
    return(
        <div onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop} className={`border border-dashed rounded-lg p-10 text-center cursor-pointer transition w-[60vw] h-[40vh] my-6 bg-blue-200 ${dragActive ? "border-blue-500" : "border-gray-300" }`}
